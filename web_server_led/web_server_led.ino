      ...
      currentTime = millis();
        if (client.available()) {
          ...
          if (c == '\n' && blank_line) {
            ...
            if(header.indexOf("c2FyYWg6bGFidGVsa29t") >= 0) {
              //successful login
              ...
              client.println("<h2>STATUS LAMPU MERAH: " + gpio5_state);
              ...
              client.println("</div>");
              client.println("<h2>STATUS LAMPU KUNING: " + gpio4_state);
              client.println("<div class=\"row\">");
